...
* [Kyle的笔刷预设](https://www.adobe.com/products/photoshop/brushes.html)
...
* **自动展开**\
  默认情况下，Substance Painter现在会自动为缺少坐标的网格生成UV坐标。 这适用于项目创建和网格重新导入。 但是，可以通过进入[主要设置](https://helpx.adobe.com/substance-3d/unlisted/documentation/spdoc/general-71008262.html)并在&#x200B;**导入选项**&#x200B;下禁用&#x200B;**启用自动UV解封**&#x200B;来禁用此行为。
