...
此版本中包括的一个新导出器是对Adobe Standard Material的支持，可与Adobe Dimension（以前AdobeProject Felix）一起使用。 我们允许您通过一键导出要导入Project Felix的场景网格及其纹理。 要访问它，只需在导出纹理窗口中选择“**Adobe Standard Material**”即可。 有关详细信息，请参阅： [http://www.adobe.com/products/dimension.html](https://www.adobe.com/products/dimension.html)
...
我们还添加了对&#x200B;**glTF**&#x200B;文件格式的支持，导出了&#x200B;**场景网格**&#x200B;和&#x200B;**PBR纹理**（金属/粗糙度）。 要访问它，只需在导出纹理窗口中选择“**glTF PBR Metal粗糙度**”即可。 **glTF**&#x200B;是由Khronos组指导的开源文件格式。 您可以在&#x200B;**Windows 10**&#x200B;中查看您的glTF文件，或者直接使用WebGL查看器，例如&#x200B;[**Babylon**](http://sandbox.babylonjs.com/)。
...
顶部的按钮允许将滤镜的结果替换为渐变本身，以在2D 视图中可视化渐变。
...
在此版本中，应用程序不同停靠区的&#x200B;**选项卡**&#x200B;现在位于各自窗口的&#x200B;**顶部，而不是底部**。 这一选择不仅有助于提高界面的可读性，而且与其它应用程序更加一致。 此更改之后将选项卡标题旁边的&#x200B;**小叉号**&#x200B;引入&#x200B;**轻松关闭它**。 也可以&#x200B;**右键单击选项卡**&#x200B;以显示&#x200B;**上下文菜单**（允许关闭或取消停靠窗口）。 取消停靠窗口的快捷键是只需将选项卡拖放到窗口区域之外。

现在也可以通过从文件资源管理器中将项目&#x200B;**拖放到视口**&#x200B;中&#x200B;**打开项目**。 这还适用于&#x200B;**网格**&#x200B;文件：将网格文件拖放到&#x200B;**空视口**&#x200B;中可打开&#x200B;**新建项目窗口**，但在&#x200B;**已打开的项目**&#x200B;上执行此操作可打开&#x200B;**项目配置对话框**，从而可快速&#x200B;**更新网格**。
...
此版本的Substance Painter还包含有关我们管理GPU内存(VRam)方式的全新且强大的性能改进。 统一颜色（如填充图层）现在被压缩为更小的纹理，从而加快了它们在主内存和GPU内存之间的转换，但也减少了它们的内存占用和计算时间。 当打开大型项目并达到GPU内存限制时，这一点应该特别明显。
