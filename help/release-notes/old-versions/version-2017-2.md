...
**Substance Painter2017.2**&#x200B;通过锚点系统引入了一项新的强大功能。 它允许在图层堆叠中创建更高级的配置，从而开启许多新的可能性。
...
**新的效果类型**&#x200B;已添加到Substance Painter中，位于现有效果类型（如&#x200B;**滤镜**&#x200B;和&#x200B;**级别**）旁边，您现在可以找到新的&#x200B;**锚点**。 此新效果允许在&#x200B;**图层堆叠**&#x200B;中定义&#x200B;**位置**，然后可在项目的其余部分（任何其他图层）中&#x200B;**引用**。 这样就可以将图层中的Height信息用于该图层正上方的图层蒙版中，从而允许更自然的混合（如上述gif所示）。
