...
在此版本中，我们侧重于在脚本API中添加新的可能性，以便为Photoshop **实现**&#x200B;高级导出器。 要访问此新导出，只需单击主工具栏中可用的Photoshop图标（如果增效工具已激活，则为默认情况）。 该增效工具允许导出纹理集中可用的完整图层栈栈，并在PSD文件内创建类似结构。 此功能&#x200B;**需要在计算机上安装Photoshop**&#x200B;才能生成PSD文件。
