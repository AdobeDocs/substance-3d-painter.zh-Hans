...
<table>
  <tr style="border: 0;">
    ...
    <td style="border: 0;" valign="top"><strong>描述</strong><br>金属Edge Wear生成器会在网格最容易被敲击或划伤的区域造成损坏和磨损的痕迹。<br><br>金属Edge Wear生成器输出单色（黑白）纹理。 因此，它对于生成蒙版以向图层添加边缘磨损细节很有用。<br><br>需要烘焙的位置、弯曲、ambient occlusion和世界空间法线映射作为图像输入。 <a href="../../../baking/baking.md">在此处了解有关烘焙的更多信息</a>。</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>将ambient occlusion用作蒙版，以防止被遮挡区域接收风化效果。</td>
  </tr>
  <tr>
    <td><strong>弯曲粗细</strong></td>
    <td>调整弯曲图对最终结果的影响程度。 弯曲图是生成器用来定义边缘的，因此很低的弯曲重量可以消除所有边缘磨损，只留下了污渍。</td>
  </tr>
</table>
