...
<table>
  <tr style="border: 0;">
    <td style="border: 0;" valign="top"><img src="../../../assets/generators/icon_position.webp" alt=""/><br><strong>英寸：</strong>网格，uv，距离</td>
    <td style="border: 0;" valign="top"><strong>描述</strong><br>位置生成器使用烘焙的位置和世界空间法线映射来根据材料在3D空间中的位置创建渐变蒙版（例如从上到下或从侧到侧）。<br><br>位置生成器输出单色（黑白）纹理。 因此，它对于根据世界空间中的位置生成渐变蒙版非常有用。需要<br><br>烘焙的位置和世界空间法线映射作为图像输入。 <a href="../../../baking/baking.md">在此处了解有关烘焙的更多信息</a>。</td>
  </tr>
</table>
