...
breadcrumb-title: ''
description: 使用Substance 3D Painter中的“Polygon Fill Tool”（多边形填充工具）为选定的多边形填充绘画，实现高效的纹理绘画。
...
**多边形填充**&#x200B;工具(![](../../assets/image2018-6-12-18-15-12.png))允许您将选定的多边形转换为像素蒙版以快速绘制蒙版。 它可能看起来像来自其他3DCC应用程序的3D选择工具，但实际上是一种生成像素数据的绘画填充工具。 这意味着可以通过使用它来选择或取消选择绘画白色。
...
* ![](../../assets/image2020-9-30-11-32-12.png) **多边形填充** — 填充整个多边形。 如果您的网格已在导出时进行三角化，则不会执行任何与“三角形填充”不同的操作。
