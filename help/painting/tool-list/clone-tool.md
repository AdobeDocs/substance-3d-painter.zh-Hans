...
在Substance 3D Painter 2中引入的仿制工具与[绘画工具](https://support.allegorithmic.com/documentation/display/SPDOC/Paint+brush)共享相同类型的参数。 正如其名称所表明的那样，仿制工具允许您从一点将特定图层或完整图层堆叠的内容复制到另一点。

![](../../assets/clone-01.gif)

## 使用情况

使用仿制工具的最简单的方法是在绘画图层的内容上使用它。
...
使用仿制工具的一种更智能的方法是创建一个绘画图层，并将所有通道的混合模式设置为“穿透”。 这样，就可以从“仿制图层”下方的所有图层以非破坏性方式复制任何信息。 下面的图层将保持不变，仿制图层将考虑稍后应用的任何修改：
