...
breadcrumb-title: ''
description: 使用Substance 3D Painter中的圆柱投影从圆柱投影纹理，以将纹理绕圆柱对象环绕。
...
填充的圆柱投影允许围绕对象投射图像和图案。 它可以适合柱子或柱子以及手臂等有机形状。
...
| **背面剔除** | 启用背面消隐允许以与圆柱体垂直的角度清除投影。 “硬度”滑块定义投影在中间角度（不是完整的90度）时的柔和程度。 <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/cylindrical-proj.gif" width="500px"/></div> |
