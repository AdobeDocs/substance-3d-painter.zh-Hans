...
breadcrumb-title: ''
description: 了解如何在Substance 3D Painter中使用和管理笔刷预设，以简化纹理绘画工作流程。
...
预设是[绘画工具](../../painting/tool-list/tool-list.md)的已保存配置。 它们可以是三种不同类型之一：

* **笔刷预设** ：保存画笔参数（大小、流量、抖动、模板和Alpha）。
* **材质预设** ：保存材料属性（单个通道和Substance文件）。
* **工具预设** ：保存画笔和材料属性以及使用的工具类型（绘画、涂抹、仿制等）。

预设保存在[资源](../../interface/assets/assets.md)文件夹下的磁盘上。 它们可以轻松地跨计算机复制，因为它们嵌入了它们使用的所有资源。
...
* [笔刷预设(ABR)](../../painting/presets/photoshop-brush-presets/photoshop-brush-presets-abr.md)
