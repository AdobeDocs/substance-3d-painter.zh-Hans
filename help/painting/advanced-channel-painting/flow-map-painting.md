...
虽然规划了专用通道，但同时使用“正常”通道和一些画笔参数，可以将flow maps绘画在Substance 3D Painter中。

## 第1步：创建法线图

创建16 x 16像素的纹理。 颜色必须为128、255、128，这应提供以下颜色： ![](../../assets/up-dx.png)\
...
在画笔参数中启用跟随路径功能。 将纹理（步骤1）加载到正常声道插槽中。 禁用其他通道。

![](../../assets/brush-settings-1.png){width="300px"}

## 第4步：绘画！

通过在启用“跟随网格”设置的情况下在法线图上绘画，画笔描边会将方向绘制到路径中。
